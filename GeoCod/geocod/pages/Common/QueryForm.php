	...
	<div id='commonForm'>
		<form id='searchForm'>
			<div style="width: 200px; padding-left: 0px;">
				<div id="attribute0">
					<div class="label">
						Atributos <select id="layerAttributes0" class="layerAttributes"
							onchange="FormManager.layerAttributesChange(0);">
							<?php
					...
					<div class="label">
						Valor <input id="filterValueField0" class="filterValueField"
							onkeyup="FormManager.isInteger(0,this);" type="text" />
					</div>
				...
				<div id="addButton" onclick="FormManager.addAttribute();">Adicionar
					Atributo</div>

				<input class="search" id="filterButton" type="button"
					onclick="FormManager.enableFilter();" value="Pesquisar" /> <span
					id="pr"><img src="/GeoCod/images/progressbar.gif" alt="loading" />
				</span>
