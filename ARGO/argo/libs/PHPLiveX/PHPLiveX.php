...
class PHPLiveX {
	...
	/**
	 * include_once javascript source file and creates neccesary javascript codes
	 *
	 * @param String $filepath: The path of phplivex javascript source file. False to prevent this include_once
